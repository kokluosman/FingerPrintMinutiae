...
img = cv2.imread('Minutiae.png')
#img1 = cv2.imread('SkeletonImagee.png')
...
cv2.imwrite('gaborkernel.png', g_kernel)
cv2.imwrite('gaborkernel1.png', g_kernel1)
cv2.imwrite('per1.png', thresh1)
